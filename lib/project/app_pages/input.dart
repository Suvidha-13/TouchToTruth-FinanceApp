...
import 'package:touch2truth/project/classes/keyboard.dart';
import 'package:touch2truth/project/classes/saveOrSaveAndDeleteButtons.dart';
...
var time = Time(hour: selectedTime.hour, minute: selectedTime.minute);
